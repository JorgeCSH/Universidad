...
'''
Ejemplo de uso. Este originalmente fue probado con arreglo para valores aleatorios, debería ser el mismo resultado pero
con los números aleatorios. 
Se decidió dejar el caso más simple para que sea más fácil de visualizar (por lo menos para mi jeje).
Nota de autor: en el x1 se cambió el 1 para evitar monotonía (y dar una referencia escondida).
'''
